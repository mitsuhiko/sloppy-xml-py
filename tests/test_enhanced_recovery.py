...
class TestAdvancedRecovery:
    ...
    def test_advanced_recovery(self):
        ...
        element_events = [e for e in events if type(e).__name__ in ['StartElement', 'EndElement']]
...
class TestRecoveryStrategies:
    ...
    def test_recovery_strategies(self):
        ...
        for strategy, name in strategies:
            ...
            element_count = sum(1 for e in events if type(e).__name__ in ['StartElement', 'EndElement'])
